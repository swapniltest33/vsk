...
@Component({
      ...
      <div class="auth-card card">
        ...
        <form [formGroup]="form" (ngSubmit)="onSubmit()">
          <div class="field">
            ...
            <span class="error" *ngIf="form.get('name')?.invalid && form.get('name')?.touched">Name is required</span>
          </div>
          <div class="field">
            <label>Email</label>
          ...
          <div class="field">
            ...
            <span class="error" *ngIf="form.get('password')?.invalid && form.get('password')?.touched">At least 6 characters required</span>
          </div>
  ...
  styles: [`
    ...
    .btn-submit { width: 100%; padding: 14px; font-size: 1rem; margin-top: 8px; }
    .auth-footer {
      margin: 24px 0 0;
      font-size: 0.9375rem;
      color: var(--color-text-muted);
